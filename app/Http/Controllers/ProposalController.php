...
class ProposalController extends Controller
{
    ...
    public function previewProposal($template, $color)
    {
        ...
        return view('proposal.templates.' . $template, compact('proposal', 'preview', 'color', 'img', 'settings', 'customer','font_color'));
    }
    ...
    public function proposal($proposal_id)
    {
        ...
        if($proposal)
        {
            ...
            $font_color = Utility::getFontColor($color);
            return view('proposal.templates.' . $settings['proposal_template'], compact('proposal', 'color', 'settings', 'customer', 'img','font_color'));
        }
        else
        {
            return redirect()->back()->with('error', __('Permission denied.'));
