                            ...
                            <div class="d-flex justify-content-between w-100">
                                ...
                                <div class="card-header-action">
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu dropdown-list dropdown-menu-right Filter-dropdown {{isset($_GET['date'])?'show':''}}" style="width: 640px">
                                    ...
                                    @can('create transfer')
                                        <a href="#" data-url="{{ route('transfer.create') }}" data-ajax-popup="true" data-title="{{__('Create New Transfer Amount')}}" class="btn btn-icon icon-left btn-primary">
                                                        ...
                                                        <tr class="font-style">
                                                            ...
                                                            @if(Gate::check('edit transfer') || Gate::check('delete transfer'))
                                                                <td class="action text-right">
                                                                    @can('edit transfer')
                                                                        <a href="#!" class="btn btn-primary btn-action mr-1" data-url="{{ route('transfer.edit',$transfer->id) }}" data-ajax-popup="true" data-title="{{__('Edit Transfer Amount')}}" data-toggle="tooltip" data-original-title="{{__('Edit')}}">
                                                                            <i class="fas fa-pencil-alt"></i>
                                                                        </a>
                                                                    @endcan
                                                                    @can('delete transfer')
                                                                        <a href="#!" class="btn btn-danger btn-action " data-toggle="tooltip" data-original-title="{{__('Delete')}}" data-confirm="{{__('Are You Sure?').' | '.__('This action can not be undone. Do you want to continue?')}}" data-confirm-yes="document.getElementById('delete-form-{{$transfer->id}}').submit();">
