                                                                ...
                                                                <td class="action text-right">
                                                                    @if($account->holder_name!='Cash')
                                                                        @can('edit bank account')
                                                                            <a href="#!" class="btn btn-primary btn-action mr-1" data-url="{{ route('bank-account.edit',$account->id) }}" data-ajax-popup="true" data-title="{{__('Edit Account')}}" data-toggle="tooltip" data-original-title="{{__('Edit')}}">
