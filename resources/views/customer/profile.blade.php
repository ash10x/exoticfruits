                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            ...
                                                            {{Form::textarea('billing_address',null,array('class'=>'form-control','placeholder'=>__('Enter Billing Address')))}}
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            ...
                                                            {{Form::textarea('shipping_address',null,array('class'=>'form-control','placeholder'=>__('Enter Shipping Address')))}}
