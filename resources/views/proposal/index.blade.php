                            ...
                            <div class="d-flex justify-content-between w-100">
                                ...
                                <div class="card-header-action">
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu dropdown-list dropdown-menu-right Filter-dropdown w-64 {{isset($_GET['customer'])?'show':''}}">
                                            @if(!\Auth::guard('customer')->check())
                                    ...
                                    @can('create proposal')
                                        <a href="{{ route('proposal.create',0) }}" class="btn btn-icon icon-left btn-primary">
                                                        ...
                                                        <tr class="font-style">
                                                            ...
                                                            @if(Gate::check('edit proposal') || Gate::check('delete proposal') || Gate::check('show proposal'))
                                                                <td class="action text-right">
                                                                    ...
                                                                    @else
                                                                        @can('convert invoice')
                                                                            <a href="{{ route('invoice.show',$proposal->converted_invoice_id) }}" class="btn btn-warning btn-action mr-1" data-toggle="tooltip" data-original-title="{{__('Already convert to Invoice')}}" data-toggle="tooltip" data-original-title="{{__('Delete')}}">
