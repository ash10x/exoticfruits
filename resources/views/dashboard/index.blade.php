                                                ...
                                                <div class="col-xs-12 col-sm-12 col-md-5">
                                                    <div class="card-header">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-auto">
                                                                {{ number_format($percentage, \Utility::getValByName('decimal_number'), '.', '')}}%
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="card-body">
                                                        <div class="progress">
                                                            <div class="progress-bar bg-warning" style="width:{{number_format($goal->target($goal->type,$goal->from,$goal->to,$goal->amount)['percentage'], \Utility::getValByName('decimal_number'), '.', '')}}%"></div>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
