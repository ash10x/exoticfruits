                                                        ...
                                                        <tr class="font-style">
                                                            ...
                                                            <td class="action text-right">
                                                                @can('edit constant category')
                                                                    <a href="#" class="btn btn-primary btn-action mr-1" data-url="{{ route('product-unit.edit',$unit->id) }}" data-ajax-popup="true" data-title="{{__('Edit Unit')}}" data-toggle="tooltip" data-original-title="{{__('Edit')}}">
