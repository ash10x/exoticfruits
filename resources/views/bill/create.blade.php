                                ...
                                <div class="col-md-6">
                                    <div class="form-group" id="vender-box">
                                        <div class="input-group">
                                            ...
                                            {{ Form::select('vender_id', $venders,$vendorId, array('class' => 'form-control customer-sel font-style selectric ','id'=>'vender','data-url'=>route('bill.vender'),'required'=>'required')) }}
                                        </div>
                                    </div>
