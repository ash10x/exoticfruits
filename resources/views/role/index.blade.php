                                                ...
                                                @foreach ($roles as $role)
                                                    <tr class="font-style">
                                                        ...
                                                        <td class="action">
                                                            ...
                                                            @can('edit role')
                                                                <a href="#" class="btn btn-primary btn-action mr-1" data-url="{{ route('roles.edit',$role->id) }}" data-size="xl" data-ajax-popup="true" data-toggle="tooltip" data-original-title="{{__('Edit')}}" data-title="{{__('Edit Role')}}">
