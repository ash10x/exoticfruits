        ...
        <div class="form-group">
            @if(!empty($permissions))
                ...
                <table class="table table-striped mb-0" id="dataTable-1">
                    ...
                    <tbody>
                    @php
                        $modules=['dashboard','user','role','proposal','invoice','bill','revenue','payment','proposal product','invoice product','bill product','goal','credit note','debit note','bank account','transfer','transaction','product & service','customer','vender','constant tax','constant category','constant unit','constant payment method','constant custom field','company settings','assets','report'];
